...
CREATE TABLE "escalation_events" (
	...
	"escalation_within_2_msgs" boolean
);
--> statement-breakpoint
...
CREATE TABLE "room_reservations" (
	...
	"status" varchar(32) DEFAULT 'pending' NOT NULL,
	"profile" varchar(64) DEFAULT 'pelangi' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE INDEX "idx_conv_audit_phone" ON "conversation_audit" USING btree ("phone");--> statement-breakpoint
CREATE INDEX "idx_conv_audit_timestamp" ON "conversation_audit" USING btree ("timestamp");--> statement-breakpoint
CREATE INDEX "idx_conv_audit_phone_timestamp" ON "conversation_audit" USING btree ("phone","timestamp");--> statement-breakpoint
CREATE INDEX "idx_conv_audit_intent" ON "conversation_audit" USING btree ("intent");--> statement-breakpoint
CREATE INDEX "idx_conv_audit_profile" ON "conversation_audit" USING btree ("profile_id");--> statement-breakpoint
CREATE INDEX "idx_conv_audit_guest_id" ON "conversation_audit" USING btree ("guest_id");--> statement-breakpoint
...
CREATE INDEX "idx_dlq_guest_id" ON "dead_letter_queue" USING btree ("guest_id");--> statement-breakpoint
CREATE INDEX "idx_dlq_profile" ON "dead_letter_queue" USING btree ("profile");--> statement-breakpoint
CREATE INDEX "idx_dlq_failed_at" ON "dead_letter_queue" USING btree ("failed_at");--> statement-breakpoint
CREATE INDEX "idx_dlq_expires_at" ON "dead_letter_queue" USING btree ("expires_at");--> statement-breakpoint
...
CREATE INDEX "idx_intent_analytics_profile_id" ON "intent_analytics" USING btree ("profile_id");--> statement-breakpoint
CREATE INDEX "idx_intent_analytics_intent_type" ON "intent_analytics" USING btree ("intent_type");--> statement-breakpoint
CREATE INDEX "idx_intent_analytics_profile_intent" ON "intent_analytics" USING btree ("profile_id","intent_type");--> statement-breakpoint
CREATE INDEX "idx_intent_analytics_created_at" ON "intent_analytics" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX "idx_room_reservations_check_in" ON "room_reservations" USING btree ("check_in_date");--> statement-breakpoint
CREATE INDEX "idx_room_reservations_check_out" ON "room_reservations" USING btree ("check_out_date");--> statement-breakpoint
CREATE INDEX "idx_room_reservations_profile" ON "room_reservations" USING btree ("profile");--> statement-breakpoint
CREATE INDEX "idx_room_reservations_status" ON "room_reservations" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_room_reservations_room_id" ON "room_reservations" USING btree ("room_id");--> statement-breakpoint
